;(() => {
  try {
    ...
    if (sessionStorage.getItem('__DOMAIN__') === targetDomain) {
      ...
      showTempNotificationAndReload(`Domain switched back to default (${defaultDomain}). Reloading...`)
    } else {
    ...
    const currentDomain = sessionStorage.getItem('__DOMAIN__') || `Not set (using default: ${defaultDomain})`
    console.info(
