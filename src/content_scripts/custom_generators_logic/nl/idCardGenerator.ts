...
// Dutch ID card number format: 9 characters
...
/**
 * Generates a valid Dutch ID card number
 * Format: 2 letters + 7 digits
 * @returns Valid Dutch ID card number
 */
export const generateNlIdCardNumber = (): string => {
  ...
  // For Dutch ID cards, the control digit is typically the last digit of the number part
